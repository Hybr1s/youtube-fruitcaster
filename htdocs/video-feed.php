...
<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:atom="http://www.w3.org/2005/Atom" version="2.0">
	<channel>
		...
		<itunes:new-feed-url>http://penndorf.me/rfc/video-feed.php</itunes:new-feed-url>		

			<?php foreach ($items as $item) { ?>
			<item>
				<title><?=$item["title"];?></title>
				<description><![CDATA[<?=$item["description"];?>]]></description>
				<enclosure url="http://penndorf.me/rfc/data/videos/<?=$item["id"];?>.mp4" length="<?=$item["filesize"];?>" type="video/mp4" />
				<guid>http://penndorf.me/rfc/data/videos/<?=$item["id"];?>.mp4</guid>
